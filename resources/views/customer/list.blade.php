    ...
    <table id="supplier" class="table responsive jumbo_table" style="width:100%">
      ...
      <tbody>
        ...
        <tr data-user-id="{{ $customers->id }}">
          ...
          <td><a href="{!! url('/customer/list/' . $customers->id) !!}">{{ $customers->name }} </a><a data-toggle="tooltip" data-placement="bottom" title="First Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
          <td>{{ $customers->lastname }} <a data-toggle="tooltip" data-placement="bottom" title="Last Name" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
          <td>{{ $customers->email }} <a data-toggle="tooltip" data-placement="bottom" title="Email" class="text-primary"><i class="fa fa-info-circle" style="color:#D9D9D9"></i></a></td>
