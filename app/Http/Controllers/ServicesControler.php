...
<?php
	...
	public function view($id)
	{
		...
		return view('/service/view', compact('service', 'vehical', 'employee', 'customer', 'regi_no', 'tbl_custom_fields', 'washbayPrice', 'branchDatas', 'repairCategoryList', 'available1', 'job_card_data'));	
	}
}
